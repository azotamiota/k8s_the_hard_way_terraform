...
# Uncomment to generate Token auth file for static token file authentication.
...
# --token-auth-file=/root/token.csv # uncomment if you generated a static token auth file (not recommended)
